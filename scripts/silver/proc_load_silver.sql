...
BEGIN
	...
	BEGIN TRY
		...
		SELECT
			cst_id,
			cst_key,
			TRIM(cst_firstname) AS cst_firstname,		-- trim: remove unwanted space
			TRIM(cst_lastname) AS cst_lastname,

			CASE WHEN UPPER(TRIM(cst_marital_status)) = 'S' THEN 'Single'		-- trim and convert to uppercase before formatting
				 WHEN UPPER(TRIM(cst_marital_status)) = 'M' THEN 'Married'
				 ELSE 'n/a'
			END cst_marital_status,

			CASE WHEN UPPER(TRIM(cst_gndr)) = 'F' THEN 'Female'		-- trim and convert to uppercase before formatting
