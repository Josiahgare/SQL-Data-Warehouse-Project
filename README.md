...
2.  **Silver Layer:** This layer includes data cleansing, standardization, and normalizationprocesses to prepare data for analysis
3.  **Gold Layer:** Contains business-ready data modeled into a star schema required for reporting and analysis
